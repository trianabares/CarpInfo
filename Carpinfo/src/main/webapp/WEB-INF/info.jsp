				...
				<div id="container">
					<div id="header">
						<div id="header_left">
							<div id="site_title">
								<h1>
									<a href="/"> <img src="images/logo.png" alt="" /> <span>
											Carpinfo </span>
									</a>
								</h1>
							</div>
							...
							<div id="content">
								<div class="content_section">
									<h2>¡Bienvenidos a la sección informacion util del Delta
										de Tigre!</h2>
									<p>Aquí encontrarán toda la información que necesitan para
										disfrutar al máximo de este hermoso destino. Ya sea que estén
										planeando un relajante paseo en lancha, o si sos residente y
										necesitas conocer los horarios del catamarán sanitario, estén
										interesados en las alturas de la marea o quieran saber cuándo
										pasa la chata que reparte agua potable, ¡han llegado al lugar
										indicado!</p>
								...
								<div class="content_section">
									...
									<p class="em_text">En esta sección, podrás acceder al recorrido del
									catamarán sanitario, diseñado para brindar asistencia médica en el delta.
									 Te proporcionaremos los horarios y lugares donde podrás abordar este servicio.</p>
									<p class="em_text"> Además, tefacilitaremos los números de teléfono de las salas de primeros
									auxilios, los bomberos, la prefectura y la policía. Estos
									contactos son fundamentales para que puedas recibir ayuda y
									asistencia en caso de cualquier eventualidad.</p>
									 <p class="em_text"> Nuestra prioridad es tu bienestar, por lo que te invitamos a explorar esta
									sección y tener a mano esta información valiosa.</p>
								<ul class="featured_tour float_l">
									<li><a href="#">Por la mañana <span>7:00 hs</span></a></li>
									<li><a href="#">Proin at urna eu sem convallis
											elementum <span>Ut dapibus tincidunt tempus. Aliquam
					...
					<div id="template_sidebar">
						...
						<div class="cleaner_h30"></div>
						<div class="image_wrapper">
							<a href="#"><img src="images/image_02.jpg" alt="" width="260"
								height="120" /></a>
						</div>
						<h3>Jardinería</h3>
						<p>Donec augue sem, interdum sed elementum a, feugiat id
